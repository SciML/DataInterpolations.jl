...
corresponding to `(u,t)` pairs.
  ...
  - `QuinticSplineInterpolation(ddu, du, u, t)` - A fifth order Hermite interpolation, which matches the values and first (`du`) and second (`ddu`) order derivatives in the data points exactly.
