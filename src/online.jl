...
function append!(di::LinearInterpolation{U, T}, u::U, t::T, safetycopy::Bool = false) where {U, T}
...
function append!(di::QuadraticInterpolation{U, T}, u::U, t::T, safetycopy::Bool = false) where {U, T}
    u, t = munge_data(u, t, safetycopy)
    append!(di.u, u)
    append!(di.t, t)
    di
...
function append!(di::ConstantInterpolation{U, T}, u::U, t::T, safetycopy::Bool = false) where {U, T}
    u, t = munge_data(u, t, safetycopy)
    append!(di.u, u)
    append!(di.t, t)
    di
