...
@testset "Linear Interpolation" begin
    ...
    @test_throws DataInterpolations.UpExtrapolationError DataInterpolations.derivative(
        A, t_eval)
    @test_throws DataInterpolations.UpExtrapolationError DataInterpolations.derivative(
        A, t_eval, 2)
    @test_throws DataInterpolations.UpExtrapolationError DataInterpolations.integral(
        A, t_eval)
    ...
    @test_throws DataInterpolations.DownExtrapolationError DataInterpolations.derivative(
        A, t_eval)
    @test_throws DataInterpolations.DownExtrapolationError DataInterpolations.derivative(
        A, t_eval, 2)
    @test_throws DataInterpolations.DownExtrapolationError DataInterpolations.integral(
        A, t_eval)
